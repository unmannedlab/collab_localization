...
if exist('EKF_rmse','var')
    subplot(1,2,1); hold on; histogram(EKF_rmse(1,:), xEdges, 'DisplayName', 'EKF'); hold off;
    subplot(1,2,2); hold on; histogram(EKF_rmse(2,:), yEdges, 'DisplayName', 'EKF'); hold off;
%     subplot(1,3,3); hold on; histogram(EKF_rmse(3,:), tEdges, 'DisplayName', 'EKF'); hold off;
end

if exist('DCL_rmse','var')
    subplot(1,2,1); hold on; histogram(DCL_rmse(1,:), xEdges, 'DisplayName', 'DCL'); hold off;
    subplot(1,2,2); hold on; histogram(DCL_rmse(2,:), yEdges, 'DisplayName', 'DCL'); hold off;
%     subplot(1,3,3); hold on; histogram(DCL_rmse(3,:), tEdges, 'DisplayName', 'DCL'); hold off;
end

if exist('DC2_rmse','var')
    subplot(1,2,1); hold on; histogram(DC2_rmse(1,:), xEdges, 'DisplayName', 'DC2'); hold off;
    subplot(1,2,2); hold on; histogram(DC2_rmse(2,:), yEdges, 'DisplayName', 'DC2'); hold off;
%     subplot(1,3,3); hold on; histogram(DC2_rmse(3,:), tEdges, 'DisplayName', 'DC2'); hold off;
end

if exist('CKF_rmse','var')
    subplot(1,2,1); hold on; histogram(CKF_rmse(1,:), xEdges, 'DisplayName', 'CKF'); hold off;
    subplot(1,2,2); hold on; histogram(CKF_rmse(2,:), yEdges, 'DisplayName', 'CKF'); hold off;
%     subplot(1,3,3); hold on; histogram(CKF_rmse(3,:), tEdges, 'DisplayName', 'CKF'); hold off;
end

if exist('EKF_LMK_rmse','var')
    subplot(1,2,1); hold on; histogram(EKF_LMK_rmse(1,:), xEdges, 'DisplayName', 'EKF LMK'); hold off;
    subplot(1,2,2); hold on; histogram(EKF_LMK_rmse(2,:), yEdges, 'DisplayName', 'EKF LMK'); hold off;
%     subplot(1,3,3); hold on; histogram(EKF_LMK_rmse(3,:), tEdges, 'DisplayName', 'EKF LMK'); hold off;
end

if exist('DCL_LMK_rmse','var')
    subplot(1,2,1); hold on; histogram(DCL_LMK_rmse(1,:), xEdges, 'DisplayName', 'DCL LMK'); hold off;
    subplot(1,2,2); hold on; histogram(DCL_LMK_rmse(2,:), yEdges, 'DisplayName', 'DCL LMK'); hold off;
